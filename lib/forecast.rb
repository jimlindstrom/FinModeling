module FinModeling
  class Forecast # FIXME: this doesn't feel like the right spot for these.  Make a self.forecast on re_is and re_bs?
    def self.next_reformulated_income_statement(period, policy, last_re_bs, last_re_is)
    ...
    def self.next_reformulated_balance_sheet(period, policy, last_re_bs, next_re_is)
